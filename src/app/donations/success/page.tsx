...
function PaymentSuccessContent() {
  ...
  useEffect(() => {
    ...
    const checkPaymentStatus = async () => {
      ...
      try {
        const donation = await apiGet<{ payment_status?: string }>(`/api/donations/${donationId}`)
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center">
        ...
        {paymentStatus === "checking" && (
          <div>
            <Text className="text-gray-600 mb-4">Verifying your donation...</Text>
        ...
        {paymentStatus === "paid" && (
          <div>
            <Text className="text-gray-600 mb-4">Your donation has been confirmed. Thank you for your support!</Text>
            <Text className="text-sm text-gray-500">Redirecting...</Text>
          </div>
        )}
        ...
        {paymentStatus === "processing" && (
          <div>
            ...
            <Text className="text-sm text-gray-500 mb-4">
              You can check your donation status later.
            </Text>
