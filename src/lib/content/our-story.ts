export const OUR_STORY_BACKGROUND_SRC = "/images/our-story/background.png" as const

export const OUR_STORY_REACH_OUT_SRC = "/images/our-story/reach-out.JPG" as const

export const ourStoryLetter = {
  title: "A LETTER FROM THE FOUNDERS",
  paragraphs: [
    "Our story starts in the basement of Westbeth Artist Housing during the 2025 Westbeth Dance Festival. During a rehearsal break, after hours spent underground, we stepped outside to see the sun. As it often happens, in those in-between moments, the conversation drifted to the state of things: the dance world, the hustle, the quiet wins, the invisible losses.",
  ...
  signature: "~ The Founding Team of Emerging Artist Resources",
} as const

export const ourStoryStayInTouch = {
  heading: "STAY IN TOUCH",
  cardTitle: "JOIN OUR EMAIL LIST",
