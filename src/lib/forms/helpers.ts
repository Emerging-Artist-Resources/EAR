...
const EVENT_FIELD_LABELS: Partial<Record<keyof EventFormData, string>> = {
  ...
  teachers: "Teachers",
  host: "Hosting Organization/Individual(s)",
  ...
  classWorkshopDuration: "Duration",
  dropInClassesAvailable: "Drop-in classes",
  dropInClasses: "Drop-in pricing and details",
