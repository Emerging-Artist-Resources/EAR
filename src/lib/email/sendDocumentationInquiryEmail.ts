/**
 * Documentation (photography & videography) inquiry — Postmark templates + PDF attachment.
 */

import { Attachment, TemplatedMessage } from "postmark"
import { postmarkClient } from "./postmark"

export const DOCUMENTATION_INQUIRY_TEMPLATE_ADMIN = "documentation-inquiry-admin"
export const DOCUMENTATION_INQUIRY_TEMPLATE_CONFIRMATION = "documentation-inquiry-confirmation"

type SendArgs = {
  to: string
  templateAlias:
    | typeof DOCUMENTATION_INQUIRY_TEMPLATE_ADMIN
    | typeof DOCUMENTATION_INQUIRY_TEMPLATE_CONFIRMATION
  templateModel: Record<string, unknown>
  pdfBytes: Uint8Array
  pdfFileName: string
}

export async function sendDocumentationInquiryTemplatedEmail({
  to,
  templateAlias,
  templateModel,
  pdfBytes,
