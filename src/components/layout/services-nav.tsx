  ...
  return (
    <div className="group relative inline-flex flex-col items-center">
      <div className="relative inline-flex flex-col items-center">
        <Button asChild variant="none" className={cn("gap-1", isActive && "text-primary")}>
          <Link
            href="/services"
            aria-haspopup="true"
        ...
        {isActive && (
          <div className="absolute -bottom-1 left-0 right-0">
            <WavyLine color="black" height={2} wavePattern="hand-drawn" />
          </div>
        )}
      </div>
      ...
      <div className="absolute left-1/2 top-full z-50 min-w-[12rem] -translate-x-1/2 pt-1">
        <div
          className="invisible rounded-md border border-gray-200 bg-white py-1 opacity-0 shadow-lg transition-[opacity,visibility] duration-150 group-hover:visible group-hover:opacity-100 group-focus-within:visible group-focus-within:opacity-100"
          role="menu"
        >
