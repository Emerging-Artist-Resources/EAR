/** Primary wordmark used on the home landing hero and footer band. */
export const EAR_LOGO_04_SRC = "/EAR-Logos/EAR LOGOS-04.png"

/** Compact wordmark for the site footer. */
