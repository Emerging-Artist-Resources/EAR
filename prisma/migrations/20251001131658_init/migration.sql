...
-- CreateEnum
CREATE TYPE "PerformanceStatus" AS ENUM ('PENDING', 'APPROVED', 'REJECTED');
...
-- AddForeignKey
ALTER TABLE "reviews" ADD CONSTRAINT "reviews_performanceId_fkey" FOREIGN KEY ("performanceId") REFERENCES "performances"("id") ON DELETE CASCADE ON UPDATE CASCADE;
